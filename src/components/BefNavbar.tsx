...
const BefNavbar = () => {
  ...
  const getLinkClass = (href: string) =>
    pathname === href ? "text-blue-400 font-semibold" : "text-blackish"; // Jika aktif, warna merah
          ...
          >
            ...
            <div className=" flex items-center lg:hidden md:flex">
              <button
                ...
                type="button"
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-600 hover:bg-transparent hover: focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-50"
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="px-6 md:px-20 lg:px-36 pb-5">
            <button
              onClick={handleClick}
              className="lg:hidden flex  bg-blue-400 lg:text-base text-sm text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-700 items-center gap-3"
            >
              <Phone stroke="none" fill="white" className="h-5 w-5 " />
              Hubungi Kami
            </button>
